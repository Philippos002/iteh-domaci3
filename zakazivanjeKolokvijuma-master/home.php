        ...
        <div id="pregled" class="panel panel-success">
            <div class="panel-body">
                <form id="prijavaForm" action="obrada.php" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <button id="btn-izmeni" type="button" name="submit" value="Izmeni" class="btn btn-warning btn-block" data-toggle="modal" data-target="#izmeniModal" disabled>Izmeni</button>
                        </div>
                        <div class="col-md-6">
